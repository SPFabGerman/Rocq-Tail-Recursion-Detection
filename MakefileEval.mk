...
${EVAL_OUT_DIR}/%_compilation.txt : ${EVAL_OUT_DIR}/%/Program.out
	...
	@bash ./evaluation.sh ${EVAL_OUT_DIR} $(subst ${EVAL_OUT_DIR}/,,$(subst /Program.out,,$<))
...
clean-%: ${EVAL_OUT_DIR}/%
	...
	@$(MAKE) -C $< -f ../../MakefileOCaml.mk clean


clean: $(wildcard $(addprefix clean-,${EvalLibs}))
	@echo "Cleaning up intermediate files generated by Roqc"
	@rm -rf evaluation/*.{vo,vok,vos,glob}
	@rm -rf evaluation/\..*.aux
	@echo "Cleaning up evaluation output."
	@rm -rf ./${EVAL_OUT_DIR}/*.txt
